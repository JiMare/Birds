...
export const birds: Bird[] = [
  ...
  },
  {
    ...
    latin: "Anser anser",
    description:
      "Je poněkud menší než husa domácí, celkově šedohnědá, naspodu je různý počet příčných černých skvrn. Zadní část břicha a spodní ocasní krovky jsou bílé. Zobák je jednobarevně oranžový.Mladí ptáci jsou tmavší a více nahnědlí.",
    family: "vrubozobí",
    colours: ["brown", "grey"],
    height: BirdHeight.LARGE,
    image: "/images/img-birds/husa-velka.jpg",
    audio: "/audio/husa-velka.mp3",
    feed: ["plants"],
    slug: "husa-velka",
  },
  {
    ...
    latin: "Cygnus olor",
    description:
      "Náš největší vodní pták. Dospělý jedinec je čistě bílý, zobák je oranžově červený, u kořene s černým kožovitým hrbolem, u samce v době hnízdění značně zvětšeným. Mladí ptáci jsou šedohnědí.",
    family: "vrubozobí",
    colours: ["white"],
    height: BirdHeight.LARGE,
    image: "/images/img-birds/labut.jpg",
    audio: "/audio/labut.wav",
    feed: ["plants"],
    slug: "labut",
  },
  {
